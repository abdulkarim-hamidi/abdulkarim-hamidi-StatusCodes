...
public class JavalinSingleton {
    /**
     * Assignment: return the status code for a generic "client side error" 
     * in the http response
     *
     * You will not need to run app.start in this method. The test cases, or 
     * main method, will do this for you - this
